...
func StateMeter(meter amxmetrics.Meter) StateOption {
...
func (cs *State) handleMsg(mi msgInfo) {
	_, stopFn := cs.meter.FuncTimingCtx(context.Background(), "handleMsg", amxmetrics.Tag("msg", fmt.Sprintf("%T", mi.Msg)))
	defer stopFn()
