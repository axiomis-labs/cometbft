...
func StateMeter(meter axmmetrics.Meter) StateOption {
...
func (cs *State) handleMsg(mi msgInfo) {
	_, stopFn := cs.meter.FuncTimingCtx(context.Background(), "handleMsg", axmmetrics.Tag("msg", fmt.Sprintf("%T", mi.Msg)))
	defer stopFn()
