...
import (
	...
	axmmetrics "github.com/axiomis-labs/metrics/v2"
...
func (conR *Reactor) Receive(e p2p.Envelope) {
	...
	_, stopFn := conR.meter.FuncTimingCtx(context.Background(), "Receive", axmmetrics.Tag("msg", fmt.Sprintf("%T", msg)))
	defer stopFn()
...
func ReactorMeter(meter axmmetrics.Meter) ReactorOption {
